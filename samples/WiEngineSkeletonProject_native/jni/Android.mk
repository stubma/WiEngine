...
LOCAL_LDLIBS := -L$(WIENGINE_LIBS)/$(TARGET_ARCH_ABI) -llog -lGLESv2 -lwiengine -llua -lwisound -lbox2d -ljson -liap -lwinetwork -lcegui
LOCAL_C_INCLUDES := $(LOCAL_PATH) \
	$(WIENGINE_JNI) \
	$(WIENGINE_JNI)/kazmath/include \
	$(WIENGINE_JNI)/lua \
	$(WIENGINE_JNI)/libcurl/include \
	$(WIENGINE_JNI)/WiEngine/include \
	$(WIENGINE_JNI)/WiEngine/include/abstraction \
	...
	$(WIENGINE_JNI)/WiEngine/include/chipmunk \
	...
	$(WIENGINE_JNI)/WiEngine/include/network \
	...
	$(WIENGINE_JNI)/WiEngine/include/spritex \
