...
public class OGGTest extends WiEngineTestActivity {
	...
	class MyLayer extends Layer {
		...
		public MyLayer() {
			...
			AudioManager.preloadEffect(R.raw.effect_ogg_mono, AudioManager.FORMAT_OGG);
			AudioManager.preloadEffect(R.raw.effect_ogg_stereo, AudioManager.FORMAT_OGG);
		}

		public void onPlay() {
			AudioManager.playBackgroundMusic(R.raw.bg_ogg, AudioManager.FORMAT_OGG, -1);
		}
		...
		public void onEffect2() {
			AudioManager.playEffect(R.raw.effect_ogg_stereo);
		}
