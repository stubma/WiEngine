...
import com.wiyun.engine.actions.grid.GridFlipY;
...
public class GridFlipYTest extends WiEngineTestActivity {
	@Override
    ...
    class MyLayer extends Layer {
        public MyLayer() {
            ...
            IntervalAction a = (IntervalAction)GridFlipY.make(4f).autoRelease();
