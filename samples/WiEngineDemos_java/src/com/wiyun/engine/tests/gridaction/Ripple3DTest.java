...
public class Ripple3DTest extends WiEngineTestActivity {
	@Override
    ...
    class MyLayer extends Layer {
        public MyLayer() {
            ...
            IntervalAction a = (IntervalAction)Ripple3D.make(4, WYGridSize.make(12, 20), s.width / 2, s.height / 2, 0, 0, 400, 0, 200, -200, 2).autoRelease();
