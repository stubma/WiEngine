...
class ResponseHandler {
     ...
     * @param isRestore 
     */
    public static void purchaseResponse(Context context, PurchaseState purchaseState, String productId,
            String orderId, long purchaseTime, String developerPayload, String signedData, String signature, boolean isRestore) {
        if (sPurchaseObserver != null) {
            sPurchaseObserver.postPurchaseStateChange(
                    purchaseState, productId, 1, purchaseTime, developerPayload, signedData, signature, isRestore);
        }
    }
	...
	public static void onVerifyPurchaseOK(String productId) {
		if (sPurchaseObserver != null) {
			sPurchaseObserver.onVerifyPurchaseOK(productId);
		}
    }

	public static void onVerifyPurchaseFailed(String productId) {
		if (sPurchaseObserver != null) {
			sPurchaseObserver.onVerifyPurchaseFailed(productId);
		}
    }
}
