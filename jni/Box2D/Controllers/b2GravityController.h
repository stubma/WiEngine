...
class BOX2D_API b2GravityController : public b2Controller{
public:
	/// Specifies the strength of the gravitiation force
	float32 G;
	/// If false, gravity is proportional to r^-2, otherwise r^-1
	bool invSqr;
...
class BOX2D_API b2GravityControllerDef : public b2ControllerDef
{
public:
	/// Specifies the strength of the gravitiation force
	float32 G;
