...
public:
    ...
    */
    ...
    /** Helper for setFlags(), setting or clearing the kAntiAlias_Flag bit
        ...
        */
    SK_API void setAntiAlias(bool aa);
    ...
    */
    ...
    SK_API void setFilterBitmap(bool filterBitmap);
    ...
    */
    SK_API void setColor(SkColor color);
    ...
    */
    ...
    /** Set or clear the typeface object.
        ...
        @return         typeface
    */
    SK_API SkTypeface* setTypeface(SkTypeface* typeface);
    ...
    */
    SK_API void setTextSize(SkScalar textSize);
    ...
    */
    SK_API SkScalar getFontMetrics(FontMetrics* metrics, SkScalar scale = 0) const;
    ...
    */
    SK_API SkScalar measureText(const void* text, size_t length,
