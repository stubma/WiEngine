...
public:
    ...
    */
    SK_API void setConfig(Config, int width, int height, int rowBytes = 0);
    ...
    */
    SK_API void setPixels(void* p, SkColorTable* ctable = NULL);
    ...
    */
    SK_API void eraseARGB(U8CPU a, U8CPU r, U8CPU g, U8CPU b) const;
    /** Initialize the bitmap's pixels with the specified color+alpha, automatically converting into the correct format
    ...
    */
    SK_API void eraseColor(SkColor c) const {
